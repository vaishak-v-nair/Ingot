...
# Cleanroom inversion (hand-tuned after remix, per the brief): this film is DARK-native
# like the product. Role mapping keeps the preset's keys — "cream" is the GROUND and is
...
borders: { hairline: "1px solid ink@12%", hairline-strong: "1px solid ink@20%", dark: "1px solid ink@14% (on navy)" }
shadows: { card: "none", none: "none" }
...
- **Fonts** — already set to **Archivo** (display) / **Public Sans** (body); ignore any preset font name lingering in prose.
